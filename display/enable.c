...
DrvEnableDriver(
   ...
   PDRVENABLEDATA pded)
{
   DbgPortLineHex("qemudisp: DrvEnableDriver, engine version ", iEngineVersion);
   ...
   if (cj >= sizeof(DRVENABLEDATA))
   {
      ...
      DbgPortLine("qemudisp: DrvEnableDriver ok");
      return TRUE;
   }
   else
   {
      DbgPortLineHex("qemudisp: DrvEnableDriver, buffer too small ", cj);
      return FALSE;
   }
}
   ...
   IN HANDLE hDriver)
{
   ...
   DbgPortLine("qemudisp: DrvEnablePDEV");

   ppdev = EngAllocMem(FL_ZERO_MEMORY, sizeof(PDEV), ALLOC_TAG);
   if (ppdev == NULL)
   {
      DbgPortLine("qemudisp: DrvEnablePDEV, EngAllocMem failed");
      return NULL;
   }
   ...
   {
      DbgPortLine("qemudisp: DrvEnablePDEV, IntInitScreenInfo failed");
      EngFreeMem(ppdev);
      return NULL;
   }
   ...
   {
      DbgPortLine("qemudisp: DrvEnablePDEV, IntInitDefaultPalette failed");
      EngFreeMem(ppdev);
      return NULL;
   }
   ...
   DbgPortLine("qemudisp: DrvEnablePDEV ok");
   return (DHPDEV)ppdev;
}
